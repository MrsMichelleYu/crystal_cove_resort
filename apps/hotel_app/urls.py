...
urlpatterns = [
    ...
    url(r'^rooms/(?P<name>\w+)$', views.room_info),
    ...
    url(r'^dining$', views.dining),
    url(r'^wellness$', views.wellness),
    url(r'^wellness/spa$', views.spa),
    url(r'^wellness/fitness$', views.fitness),
